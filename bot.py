...
def start_bot(start_url, email, college, collegeID):
    ...
    print(
        fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fr + 'Please fill the captcha in webdriver to proceed further')
    ...
    if solved == 1:
        ...
        fp.write(
            'Email - ' + email + ' Password - ' + pwd + ' UserName - ' + userName + ' First Name - ' + firstName + ' Middle Name - ' + middleName + ' Last Name - ' + LastName + ' College - ' + college + ' Pin - ' + str(
                pin) + ' Birthday - ' + birthDay + '\n\n')
        fp.close()
        print(
            fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Account Created Successfully, Details saved in myccAcc.txt, Filling Application Form Now')
...
def main():
    ...
    print(
        fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Select a college from all available colleges to proceed....\n')
    ...
    for index, college in enumerate(allColleges):
        print(fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fy + str(index + 1) + ' - ' + random.choice(
            colors) + college)
    ...
    while isIDError != False:
        print(
            '\n' + fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Enter college id for ex - 1 or 2 or 3.... : ',
            end='')
        userInput = int(input())
